...
async function main() {
  ...
  // Deploy the YellowToken contract
  ...
  const tx2 = await yellowToken
    .connect(randomPerson1) /* connect the randomPerson1 to the contract; note that we are using the randomPerson1 instead of the randomAddress1 */
    .transfer(randomAddress2, ethers.utils.parseEther("5000")); /* transfer 5000 YTK from the randomAddress to the randomAddress2 */
